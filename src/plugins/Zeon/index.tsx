...
function ZeonIndicator({ channelId }: { channelId: string; }) {
    ...
    switch (channelId) {
        ...
        case '1237024834790100992':
            icon = <><svg style={{ fill: "var(--channel-icon)", height: "24px", width: "24px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M499.1 6.3c8.1 6 12.9 15.6 12.9 25.7v72V368c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V147L192 223.8V432c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V200 128c0-14.1 9.3-26.6 22.8-30.7l320-96c9.7-2.9 20.2-1.1 28.3 5z" /></svg></>;
            break;
        case '1178489699686432828':
        case '1210399621478748230':
            icon = <><svg style={{ fill: "var(--channel-icon)", height: "24px", width: "24px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M569.5 440C588 472 564.8 512 527.9 512H48.1c-36.9 0-60-40.1-41.6-72L246.4 24c18.5-32 64.7-32 83.2 0l239.9 416zM288 354c-25.4 0-46 20.6-46 46s20.6 46 46 46 46-20.6 46-46-20.6-46-46-46zm-43.7-165.3l7.4 136c.3 6.4 5.6 11.3 12 11.3h48.5c6.4 0 11.6-5 12-11.3l7.4-136c.4-6.9-5.1-12.7-12-12.7h-63.4c-6.9 0-12.4 5.8-12 12.7z" /></svg></>;
            break;
        case '1178155999769665546':
            icon = <><svg style={{ fill: "var(--channel-icon)", height: "24px", width: "24px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M80 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48zm32.4 97.2c28-12.4 47.6-40.5 47.6-73.2c0-44.2-35.8-80-80-80S0 35.8 0 80c0 32.8 19.7 61 48 73.3V358.7C19.7 371 0 399.2 0 432c0 44.2 35.8 80 80 80s80-35.8 80-80c0-32.8-19.7-61-48-73.3V272c26.7 20.1 60 32 96 32h86.7c12.3 28.3 40.5 48 73.3 48c44.2 0 80-35.8 80-80s-35.8-80-80-80c-32.8 0-61 19.7-73.3 48H208c-49.9 0-91-38.1-95.6-86.8zM80 408a24 24 0 1 1 0 48 24 24 0 1 1 0-48zM344 272a24 24 0 1 1 48 0 24 24 0 1 1 -48 0z" /></svg></>;
            break;
        case '1169453978745065542':
        case '1155257379814920212':
        case '1155343304255348788':
            icon = <><svg style={{ fill: "var(--channel-icon)", height: "24px", width: "24px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128z" /></svg></>;
            break;
        case '1179990006140514304':
        case "1179990052437246012":
            icon = <><svg style={{ fill: "var(--channel-icon)", height: "24px", width: "24px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"></svg></>;
            break;
    }
    return (
        <Tooltip text={"zeon"!}>
