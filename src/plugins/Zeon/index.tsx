...
function ZeonIndicator({ channelId }: { channelId: string; }) {
    ...
    switch (channelId) {
        ...
        case "1224160307665174549":
            icon = <><svg style={{ fill: "var(--channel-icon)", height: "24px", width: "24px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
                <defs></defs>
        ...
        case "1193964100426936492":
            ...
            break;
        case "1243278742978166864":
            icon = <><svg style={{ fill: "var(--channel-icon)", height: "24px", width: "24px" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
